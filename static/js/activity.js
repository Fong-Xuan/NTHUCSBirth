...
(3)填問卷+理監事圈選投票禮</br>\
(4)系友惠賜名片禮<br><a href='http://csalumni.web.nthu.edu.tw/files/87-1209-2126.php?Lang=zh-tw' target='_blank'>聯誼餐會報名表</a>";activityRows.push(new ActivityRow("資工40暨資應所系所友回娘家",des,"4/23 9:30~14:00",loc,more));des="各級畢業系友預約教室開同學會"
...
(2)早到禮園遊券100份（面額NT：100元）</br>\
(3)填問卷+理監事圈選投票禮</br>\
(4)系友惠賜名片禮";scheduleRows.push(new ScheduleRow("09:30~10:00","報到",des,"台達館1樓中庭",""));des="李家同校長、陳文村校長、<br/>劉炯朗校長、唐傳義校長、黃能富院長";scheduleRows.push(new ScheduleRow("10:00~10:30","貴賓致詞",des,"台達館1樓中庭",""));des="系友會會務報告-胡大雄會長</br>\
資工系及資應所現況分享-</br>\
系主任賴尚宏教授、王廷基所長";scheduleRows.push(new ScheduleRow("10:30~10:40","開幕致詞",des,"台達館1樓中庭"," "));des="1. 資工系成立四十週年紀念影片特輯</br>\
2. 傑出校友頒獎";scheduleRows.push(new ScheduleRow("10:40~11:05","往事回味",des,"台達館1樓中庭"," "));des="";scheduleRows.push(new ScheduleRow("11:05~12:00","系友創業分享",des,"台達館1樓中庭"," "));des="由資應所的國際學生畢業後分享在台灣的工作經驗";scheduleRows.push(new ScheduleRow("11:30~12:30","國際學生在台工作經驗分享",des,"台達館108教室"," "));des="<b>美味buffet</b></br>\
...
頒發第四屆系友會理監事證書</br>\
討論年度系友會活動";scheduleRows.push(new ScheduleRow("14:00~15:00","第三屆及第四屆理監事交接會議",des,"台達館525會議室"," "));des="";scheduleRows.push(new ScheduleRow("13:10~16:00","歡唱卡啦OK",des,"台達1樓中庭"," "));des="親子專家說故事、親子勞作";scheduleRows.push(new ScheduleRow("14:00~15:00","故事樂園",des,"台達館107教室"," "));des="";scheduleRows.push(new ScheduleRow("15:00~16:00","魔術氣球秀",des,"台達館107教室"," "));var activityBody=document.getElementById("activityBody");if(activityBody){for(var i in activityRows){var tr=document.createElement("tr");tr.innerHTML="\
